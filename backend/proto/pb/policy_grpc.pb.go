...
const (
	PolicyService_CreatePolicy_FullMethodName = "/proto.PolicyService/CreatePolicy"
	PolicyService_GetPolicy_FullMethodName    = "/proto.PolicyService/GetPolicy"
	PolicyService_UpdatePolicy_FullMethodName = "/proto.PolicyService/UpdatePolicy"
	PolicyService_DeletePolicy_FullMethodName = "/proto.PolicyService/DeletePolicy"
	PolicyService_ListPolicies_FullMethodName = "/proto.PolicyService/ListPolicies"
)
...
type PolicyServiceClient interface {
	CreatePolicy(ctx context.Context, in *CreatePolicyRequest, opts ...grpc.CallOption) (*PolicyResponse, error)
	GetPolicy(ctx context.Context, in *GetPolicyRequest, opts ...grpc.CallOption) (*PolicyResponse, error)
	UpdatePolicy(ctx context.Context, in *UpdatePolicyRequest, opts ...grpc.CallOption) (*PolicyResponse, error)
...
func (c *policyServiceClient) CreatePolicy(ctx context.Context, in *CreatePolicyRequest, opts ...grpc.CallOption) (*PolicyResponse, error) {
...
func (c *policyServiceClient) GetPolicy(ctx context.Context, in *GetPolicyRequest, opts ...grpc.CallOption) (*PolicyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PolicyResponse)
...
func (c *policyServiceClient) UpdatePolicy(ctx context.Context, in *UpdatePolicyRequest, opts ...grpc.CallOption) (*PolicyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PolicyResponse)
...
type PolicyServiceServer interface {
	CreatePolicy(context.Context, *CreatePolicyRequest) (*PolicyResponse, error)
	GetPolicy(context.Context, *GetPolicyRequest) (*PolicyResponse, error)
	UpdatePolicy(context.Context, *UpdatePolicyRequest) (*PolicyResponse, error)
...
func (UnimplementedPolicyServiceServer) CreatePolicy(context.Context, *CreatePolicyRequest) (*PolicyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreatePolicy not implemented")
}
func (UnimplementedPolicyServiceServer) GetPolicy(context.Context, *GetPolicyRequest) (*PolicyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPolicy not implemented")
}
func (UnimplementedPolicyServiceServer) UpdatePolicy(context.Context, *UpdatePolicyRequest) (*PolicyResponse, error) {
...
var PolicyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.PolicyService",
